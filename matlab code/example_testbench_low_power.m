function I_reconstruct = example_testbench_low_power
...
for pixel_index = 1:numPixelsPerFrame
    ...
    [bitstream_ready, bitstream_length, subimage_index_delay, bitstream, hStart_output, hEnd_output, vStart_output, vEnd_output, valid_output] = compression_hdl_lowpower(pixelIn, hStart, hEnd, vStart, vEnd, valid, compression_mode);
